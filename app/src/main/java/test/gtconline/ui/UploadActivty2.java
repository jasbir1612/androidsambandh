...
public class UploadActivty2 extends AppCompatActivity {
        ...
        generateOtp_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(phoneNumber) || phoneNumber.length() < 10) {
                    Toast.makeText(UploadActivty2.this, "Please enter a valid phone number.", Toast.LENGTH_SHORT).show();
                    return;
                } else {
               ...
               //     Log.d("appuid",db.getAppUid().toString());
                ...
                generateOtp_btn.setBackgroundColor(ContextCompat.getColor(UploadActivty2.this, R.color.gray_btn_color));
                ...
                apiService.sendOtp(phoneNumber, new ResponseCallback<List<SendOtpResponse>>() {
                    ...
                    public void success(List<SendOtpResponse> sendOtpResponses) {
                        ...
                        generateOtp_btn.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                generateOtp_btn.setBackgroundColor(ContextCompat.getColor(UploadActivty2.this, R.color.login_btn_color));
                      ...
                      //  btnRegister.setEnabled(true);
                        ...
                        register_btn.setBackgroundColor(ContextCompat.getColor(UploadActivty2.this, R.color.login_btn_color));
                     //   btnRegister.setBackgroundColor(ContextCompat.getColor(LoginActivity.this, R.color.register_btn_color));

                        Toast.makeText(UploadActivty2.this, "Otp sent successfully to " + phoneNumber, Toast.LENGTH_SHORT).show();
                    }
                    ...
                    public void failure(List<SendOtpResponse> sendOtpResponses) {
                        generateOtp_btn.setEnabled(true);
                        generateOtp_btn.setBackgroundColor(ContextCompat.getColor(UploadActivty2.this, R.color.login_btn_color));
                        Toast.makeText(UploadActivty2.this, "Problem in sending OTP. Try again later.", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
            ...
            public void onClick(View view) {
                apiService.verifyOtp(phoneNumber, otpEt.getText().toString().trim(), db.getAppUid(), new ResponseCallback<List<VerifyOtpResponse>>() {
                    ...
                    public void success(List<VerifyOtpResponse> verifyOtpResponses) {
                        Toast.makeText(UploadActivty2.this, "Otp verified.", Toast.LENGTH_SHORT).show();
                    ...
                    public void failure(List<VerifyOtpResponse> verifyOtpResponses) {
                        Toast.makeText(UploadActivty2.this, "OTP Incorrect or expired. Please try again", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
