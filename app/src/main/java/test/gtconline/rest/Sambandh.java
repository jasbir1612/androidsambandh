...
public interface Sambandh {
    ...
    @POST("Ssmabandh/ErrorMessage")
    Call<List<ErrorMessage>> uploadErrorMessage(@Query("ErrorMessage") String errorMessage, @Query("DeviceBrand") String deviceBrand, @Query("DeviceName") String deviceName, @Query("DeviceModel") String deviceModel, @Query("DeviceId") String deviceId, @Query("Product") String product,@Query("SdkVersion") String sdkVersion,@Query("ReleaseVersion") String releaseVersion,@Query("IncrementalVersion") String incrementalVersion);
